...
public class ShujufenxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShujufenxiEntity shujufenxi,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date tongjinianfenstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date tongjinianfenend,
		HttpServletRequest request){
        EntityWrapper<ShujufenxiEntity> ew = new EntityWrapper<ShujufenxiEntity>();
                if(tongjinianfenstart!=null) ew.ge("tongjinianfen", tongjinianfenstart);
                if(tongjinianfenend!=null) ew.le("tongjinianfen", tongjinianfenend);
